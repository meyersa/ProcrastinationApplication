	...
	public static Map<Integer, Event> readCache() {
		...
		while (sc.hasNextLine()) {
			...
			if (currentLine[0].equals("ReminderEvent")) {
				map.put(Integer.valueOf(currentLine[3]), new ReminderEvent(currentLine[1], currentLine[2], Integer.parseInt(currentLine[3])));
				
			} else if (currentLine[0].equals("ScheduledEvent")) {
				map.put(Integer.valueOf(currentLine[3]), new ScheduledEvent(currentLine[1], currentLine[2], Integer.parseInt(currentLine[3]), Integer.parseInt(currentLine[4])));
